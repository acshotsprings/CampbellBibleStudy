...
const NAV_STRUCTURE = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: '↳↳ Prophecy 04 — A Virgin Will Be with Child (Isa 7:14)', href: 'DeepDive-MessianicBirth-04-Isaiah7.html', sub: true, underSubKey: 'deepdives', itemColor: 'mystudy-deepdives', completable: true, completeKey: 'complete-mb-04' },
      { label: '↳↳ Prophecy 05 — A Child Will Be Born to Us (Isa 9:6-7)', href: 'DeepDive-MessianicBirth-05-Isaiah9.html', sub: true, underSubKey: 'deepdives', itemColor: 'mystudy-deepdives', completable: true, completeKey: 'complete-mb-05' },
      { label: '↳↳ Prophecy 06 — Bethlehem: The Place of His Birth (Mic 5:2)', href: 'DeepDive-MessianicBirth-06-Micah.html', sub: true, underSubKey: 'deepdives', itemColor: 'mystudy-deepdives', completable: true, completeKey: 'complete-mb-06' },
      { label: '↳↳ Prophecy 07 — Until Messiah the Prince (Dan 9:25)', href: 'DeepDive-MessianicBirth-07-Daniel9.html', sub: true, underSubKey: 'deepdives', itemColor: 'mystudy-deepdives', completable: true, completeKey: 'complete-mb-07' },
      { label: '↳↳ Prophecy 08 — A Voice to Prepare the Way (Mal 3:1)', href: 'DeepDive-MessianicBirth-08-Malachi3.html', sub: true, underSubKey: 'deepdives', itemColor: 'mystudy-deepdives', completable: true, completeKey: 'complete-mb-08' },
      { label: '↳↳ Prophecy 09 — The Throne of His Father David (Luke 1:32-33)', href: 'DeepDive-MessianicBirth-09-Luke1.html', sub: true, underSubKey: 'deepdives', itemColor: 'mystudy-deepdives', completable: true, completeKey: 'complete-mb-09' },
      { label: '↳↳ Prophecy 10 — They Shall Call His Name Immanuel (Matt 1:22-23)', href: 'DeepDive-MessianicBirth-10-Matthew1.html', sub: true, underSubKey: 'deepdives', itemColor: 'mystudy-deepdives', completable: true, completeKey: 'complete-mb-10' },
      { label: '↳↳ Prophecy 11 — Born This Day in the City of David (Luke 2:10-12)', href: 'DeepDive-MessianicBirth-11-Luke2.html', sub: true, underSubKey: 'deepdives', itemColor: 'mystudy-deepdives', completable: true, completeKey: 'complete-mb-11' },
