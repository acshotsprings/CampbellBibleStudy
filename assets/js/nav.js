...
Sidebar Navigation Builder — v4.3 Collapsible Themes + Timestamp Button
============================================================ */
...
{ label: ‘↳ Module 4 — Feast of Tabernacles’, href: ‘/theme2/module4.html’, sub: true },
]
},
{
type: ‘section’,
...
// ── Build sidebar HTML ──
let html = `<div id="sidebar-header"> <h1>Campbell Family<br>Biblical Study Guide</h1> <p id="sidebar-version">Version: April 6, 2026</p> </div> <div id="sidebar-nav">`;
