...
const NAV_STRUCTURE = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: '↳↳ 🔬 Deep Dive — Foretold: Messiah\'s Birth', href: 'DeepDive-MessianicBirth.html', sub: true },
      { label: '↳↳↳ Prophecy 01 — The First Promise (Gen 3:15)', href: 'DeepDive-MessianicBirth-01-FirstPromise.html', sub: true, completable: true, completeKey: 'complete-mb-01' },
      { label: '↳↳↳ Prophecy 02 — The Promise Narrows: Abraham (Gen 12:3)', href: 'DeepDive-MessianicBirth-02-Abraham.html', sub: true, completable: true, completeKey: 'complete-mb-02' },
      { label: '↳↳↳ Prophecy 03 — The Promise Narrows: David (2 Sam 7:12-13)', href: 'DeepDive-MessianicBirth-03-David.html', sub: true, completable: true, completeKey: 'complete-mb-03' },
      { label: '↳↳↳ Prophecy 04 — A Virgin Will Be with Child (Isa 7:14)', href: 'DeepDive-MessianicBirth-04-Isaiah7.html', sub: true, completable: true, completeKey: 'complete-mb-04' },
      { label: '↳↳↳ Prophecy 05 — A Child Will Be Born to Us (Isa 9:6-7)', href: 'DeepDive-MessianicBirth-05-Isaiah9.html', sub: true, completable: true, completeKey: 'complete-mb-05' },
      { label: '↳↳↳ Prophecy 06 — Bethlehem: The Place of His Birth (Mic 5:2)', href: 'DeepDive-MessianicBirth-06-Micah.html', sub: true, completable: true, completeKey: 'complete-mb-06' },
      { label: '↳↳↳ Prophecy 07 — Until Messiah the Prince (Dan 9:25)', href: 'DeepDive-MessianicBirth-07-Daniel9.html', sub: true, completable: true, completeKey: 'complete-mb-07' },
      { label: '↳↳↳ Prophecy 08 — A Voice to Prepare the Way (Mal 3:1)', href: 'DeepDive-MessianicBirth-08-Malachi3.html', sub: true, completable: true, completeKey: 'complete-mb-08' },
      { label: '↳↳↳ Prophecy 09 — The Throne of His Father David (Luke 1:32-33)', href: 'DeepDive-MessianicBirth-09-Luke1.html', sub: true, completable: true, completeKey: 'complete-mb-09' },
      { label: '↳↳↳ Prophecy 10 — They Shall Call His Name Immanuel (Matt 1:22-23)', href: 'DeepDive-MessianicBirth-10-Matthew1.html', sub: true, completable: true, completeKey: 'complete-mb-10' },
      { label: '↳↳↳ Prophecy 11 — Born This Day in the City of David (Luke 2:10-12)', href: 'DeepDive-MessianicBirth-11-Luke2.html', sub: true, completable: true, completeKey: 'complete-mb-11' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: '↳↳ Ch 02b — Goliath', href: 'characters/david/02b-goliath.html', sub: true, underSubKey: 'david', completable: true, completeKey: 'complete-david-02b' },
      ...
      { label: '↳↳ Ch 08b — Uzzah and the Ark', href: 'characters/david/08b-uzzah.html', sub: true, underSubKey: 'david', completable: true, completeKey: 'complete-david-08b' },
      ...
      { label: '↳↳ Ch 09b — Mephibosheth', href: 'characters/david/09b-mephibosheth.html', sub: true, underSubKey: 'david', completable: true, completeKey: 'complete-david-09b' },
      ...
      { label: '↳↳ Ch 13b — The Census', href: 'characters/david/13b-census.html', sub: true, underSubKey: 'david', completable: true, completeKey: 'complete-david-13b' },
...
const READING_CHAIN = [
  ...
  ['DeepDive-MessianicBirth.html', 'Deep Dive — Foretold: Messiah\'s Birth', 'Theme 5 — The Messiah'],
  ['DeepDive-MessianicBirth-01-FirstPromise.html', 'Prophecy 01 — The First Promise (Gen 3:15)', 'Theme 5 — The Messiah'],
  ['DeepDive-MessianicBirth-02-Abraham.html', 'Prophecy 02 — The Promise Narrows: Abraham (Gen 12:3)', 'Theme 5 — The Messiah'],
  ['DeepDive-MessianicBirth-03-David.html', 'Prophecy 03 — The Promise Narrows: David (2 Sam 7:12-13)', 'Theme 5 — The Messiah'],
  ['DeepDive-MessianicBirth-04-Isaiah7.html', 'Prophecy 04 — A Virgin Will Be with Child (Isa 7:14)', 'Theme 5 — The Messiah'],
  ['DeepDive-MessianicBirth-05-Isaiah9.html', 'Prophecy 05 — A Child Will Be Born to Us (Isa 9:6-7)', 'Theme 5 — The Messiah'],
  ['DeepDive-MessianicBirth-06-Micah.html', 'Prophecy 06 — Bethlehem: The Place of His Birth (Mic 5:2)', 'Theme 5 — The Messiah'],
  ['DeepDive-MessianicBirth-07-Daniel9.html', 'Prophecy 07 — Until Messiah the Prince (Dan 9:25)', 'Theme 5 — The Messiah'],
  ['DeepDive-MessianicBirth-08-Malachi3.html', 'Prophecy 08 — A Voice to Prepare the Way (Mal 3:1)', 'Theme 5 — The Messiah'],
  ['DeepDive-MessianicBirth-09-Luke1.html', 'Prophecy 09 — The Throne of His Father David (Luke 1:32-33)', 'Theme 5 — The Messiah'],
  ['DeepDive-MessianicBirth-10-Matthew1.html', 'Prophecy 10 — They Shall Call His Name Immanuel (Matt 1:22-23)', 'Theme 5 — The Messiah'],
  ['DeepDive-MessianicBirth-11-Luke2.html', 'Prophecy 11 — Born This Day in the City of David (Luke 2:10-12)', 'Theme 5 — The Messiah'],
  ...
  ['characters/david/02b-goliath.html', 'Ch 02b — Goliath', 'David'],
  ...
  ['characters/david/08b-uzzah.html', 'Ch 08b — Uzzah and the Ark', 'David'],
  ['characters/david/09-covenant.html', 'Ch 09 — The Davidic Covenant', 'David'],
  ['characters/david/09b-mephibosheth.html', 'Ch 09b — Mephibosheth', 'David'],
  ...
  ['characters/david/13b-census.html', 'Ch 13b — The Census', 'David'],
